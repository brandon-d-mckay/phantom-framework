...
public class ConcurrentTimedJobQueue implements JobQueue
{
	...
	private static final long trackerUpdateJobHolderFieldOffset = objectFieldOffset(ConcurrentTimedJobQueue.class, "trackerUpdateJobHolder");
	...
	{
		if(compareAndSetObject(this, trackerUpdateJobHolderFieldOffset, trackerUpdateJob, null)) updateTracker();
	}
