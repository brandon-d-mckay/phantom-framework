...
import phantom.framework.SerialProcedureBuilderImpl.SerialProcedureTaskImpl;

class SerialProducerBuilderImpl<O> extends ConcurrentCachedSupplier<ProducerTaskImpl<O>> implements SerialProducerBuilder<O>, ProducerBuilderImpl<O>
{
